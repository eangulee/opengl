...
glm::vec3 cameraPos = glm::vec3(0.0f, 0.0f, 4.0f);//相机位置
glm::vec3 cameraFront = glm::vec3(0.0f, 0.0f, -1.0f);//相机正前方
glm::vec3 cameraUp = glm::vec3(0.0f, 1.0f, 0.0f);//相机正上方
...
int main() {
	...
	view = glm::lookAt(glm::vec3(0.0, 0.0, 4.0), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void processInput(GLFWwindow *window) {
	...
	cameraSpeed = 0.05f * deltaTime; //移动速度
